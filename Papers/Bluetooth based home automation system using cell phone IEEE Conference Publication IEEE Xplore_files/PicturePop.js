...
function cmpl_LoadPicturePops() {
    ...
    for (var i = 0; i < colorElements.length; i++) {
        ...
        if (colorContainer.hasAttribute("data-highlightcolor") && !colorContainer.classList.contains("cmpl-ready")) {
            console.log(colorContainer.hasAttribute("data-highlightcolor"));
        ...
        for (var i = 0; i < elements.length; i++) {
            ...
            if (!image_container.classList.contains("cmpl-ready")) {
                ...
                if (!image_container.hasAttribute("data-playimageurl") || image_container.dataset.playimageurl.trim() == "") {
                    play_url = 'https://stream.cadmore.media/images/svgicons/play_small.svg';
                }
                else {
                ...
                if ((typeof videoId !== 'undefined' && videoId !== null && videoId !== "")
                    ...
                    if (!image_container.hasAttribute("data-imageurl") || image_container.dataset.imageurl.trim() == "") {
                        ...
                        if (typeof altId !== 'undefined' && altId !== null && altId !== "") {
                            rotateThumbnails = getRotatingThumbnailConfig("https://stream.cadmore.media/GetThumbnailRotatingConfig?videoURL=" + encodeURIComponent(videoUrl) + "&altUrl=" + encodeURIComponent(altId), videoId, image_container, play_url, altId, delayed, accessCode, delayedAccessCode, videoUrl, interval, numberOfThumbnails, offset, i, borderSize, borderColor, borderCorner, rotateThumbnails);
                        }
                        else {
                            rotateThumbnails = getRotatingThumbnailConfig("https://stream.cadmore.media/GetThumbnailRotatingConfig?assetId=" + videoId, videoId, image_container, play_url, altId, delayed, accessCode, delayedAccessCode, videoUrl, interval, numberOfThumbnails, offset, i, borderSize, borderColor, borderCorner, rotateThumbnails);
                        }
                    }
                    else {
    ...
    function getThumbnailsToDisplay(videoId, image_container, play_url, altId, rotateThumbnails, delayed, accessCode, delayedAccessCode, videoUrl, interval, numberOfThumbnails, offset, index, borderSize, borderColor, borderCorner) {
        ...
        if (typeof altId !== 'undefined' && altId !== null && altId !== "") {
            if (rotateThumbnails) {
                script.src = 'https://stream.cadmore.media/GetThumbnailUrls?altUrl=' + encodeURIComponent(altId) + '&index=' + index + '&videoURL=' + videoUrl + "&altId=" + altId + "&videoId=" + videoId + '&accessCode=' + accessCode + '&delayedAccessCode=' + delayedAccessCode + '&interval=' + interval + '&noOfThumbnails=' + numberOfThumbnails + '&offset=' + offset;
                ...
                script.src = 'https://stream.cadmore.media/GetThumbnailAltUrl?altUrl=' + encodeURIComponent(altId) + '&index=' + index + "&altId=" + videoId;
            ...
            if (rotateThumbnails) {
                script.src = 'https://stream.cadmore.media/GetThumbnailUrls?assetId=' + videoId + '&index=' + index + '&videoURL=' + videoUrl + '&accessCode=' + accessCode + '&delayedAccessCode=' + delayedAccessCode + '&interval=' + interval + '&noOfThumbnails=' + numberOfThumbnails + '&offset=' + offset;
                //script.src = 'https://localhost:44358/GetThumbnailUrls?assetId=' + videoId + '&index=' + i + '&videoURL=' + videoUrl + '&accessCode=' + accessCode;
            }
            else {
                script.src = 'https://stream.cadmore.media/GetThumbnailUrl?videoId=' + videoId + '&index=' + index;
    ...
    function cmpl_LoadPicturePopsAjax(elements) {
        ...
        for (var i = 0; i < elements.length; i++) {
            ...
            if (typeof altId !== 'undefined' && altId !== null && altId !== "") {
                videoHighlightColorUrl = "https://stream.cadmore.media/videohighlightcolor/alturl/" + altId;
                //videoHighlightColorUrl = "https://localhost:44358/videohighlightcolor/alturl/" + altId;
            }
            else {
                videoHighlightColorUrl = "https://stream.cadmore.media/videohighlightcolor/" + videoId;
...
var cmpl_EmbedJSScriptLocation = 'https://stream.cadmore.media/Scripts/Embed.js';
