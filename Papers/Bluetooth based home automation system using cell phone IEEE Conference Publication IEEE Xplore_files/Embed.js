...
cmpl_docReady(function () {
    ...
    window.addEventListener('message', function (e) {
        try {
            if (e.origin != "https://cadmorevideotest.azurewebsites.net" && e.origin !== "https://stream.cadmore.media" && e.origin !== "https://localhost:44358") {
                //bad domain.
                return;
            }
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        if (width >= 850) {
            ...
            else if (width < 300 && isAudioPlayer)
            {
                ...
                //never exceed 165% for small devices.
                //if (isAudioPlayer && width > 600 && correctPadding > 100) {
                    //correctPadding = 85;
                //}
                //else if (correctPadding > 165) {
                    //correctPadding = 165;
            ...
            //else {
                ...
                //else {
                    //divElement.style.paddingTop = "56.25%";
                    //divElement.style.paddingTop = "165%";
                //}
            //}
        }
